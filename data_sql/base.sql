--
-- Table structure for table `ameli_at`
--

CREATE TABLE IF NOT EXISTS `ameli_at` (
  `annee` smallint(6) NOT NULL,
  `CTN` varchar(2) NOT NULL,
  `NAF` varchar(5) NOT NULL,
  `NAF38` varchar(2) DEFAULT NULL,
  `NAF2` varchar(2) DEFAULT NULL,
  `NbSalariesEnActiviteOuChoPar` int(11) DEFAULT NULL,
  `nbHeuresTrav` int(11) DEFAULT NULL,
  `nbSiret` int(11) DEFAULT NULL,
  `AT1erReg` int(11) DEFAULT NULL,
  `AT1erReg4joursArret` int(11) DEFAULT NULL,
  `nouvellesIP` int(11) DEFAULT NULL,
  `nouvellesIPTauxInf10Pct` int(11) DEFAULT NULL,
  `nouvellesIPTauxSup10Pct` int(11) DEFAULT NULL,
  `deces` int(11) DEFAULT NULL,
  `journeesIT` int(11) DEFAULT NULL,
  `sommeTauxIPInf10Pct` int(11) DEFAULT NULL,
  `sommeTauxIP` int(11) DEFAULT NULL,
  `manutentionManuelle` varchar(5) DEFAULT NULL,
  `chutesPlainPied` varchar(4) DEFAULT NULL,
  `outillageMain` varchar(4) DEFAULT NULL,
  `risqueMachine` varchar(3) DEFAULT NULL,
  `chutesHauteur` varchar(4) DEFAULT NULL,
  `agressions` varchar(3) DEFAULT NULL,
  `manutentionMecanique` varchar(4) DEFAULT NULL,
  `risquePhysiqueDontRisqueElec` varchar(2) DEFAULT NULL,
  `risqueChimique` varchar(3) DEFAULT NULL,
  `risqueRoutier` varchar(3) DEFAULT NULL,
  `autresRisques` varchar(3) DEFAULT NULL,
  `autresVehiculesTransport` varchar(3) DEFAULT NULL,
  `ficheSinistralite` varchar(3) DEFAULT 'non',
  PRIMARY KEY (`annee`,`CTN`,`NAF`),
  KEY `annee_NAF` (`annee`,`NAF`),
  KEY `NAF` (`NAF`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Table structure for table `ameli_mp`
--

CREATE TABLE IF NOT EXISTS `ameli_mp` (
  `annee` smallint(6) NOT NULL,
  `CTN` varchar(2) DEFAULT NULL,
  `NAF` varchar(5) DEFAULT NULL,
  `NAF38` varchar(2) DEFAULT NULL,
  `NAF2` varchar(2) DEFAULT NULL,
  `MP` varchar(4) DEFAULT NULL,
  `MPlabel` text,
  `CIM10` varchar(9) DEFAULT NULL,
  `CIM10label` text,
  `nbSalariesEnActiviteOuChoPar` varchar(6) DEFAULT NULL,
  `HeuresTravaillees` varchar(10) DEFAULT NULL,
  `NbEtablissements` varchar(5) DEFAULT NULL,
  `MP1erReg` int(11) DEFAULT NULL,
  `NouvellesIP` int(11) DEFAULT NULL,
  `NouvellesIPtauxInf10Pct` int(11) DEFAULT NULL,
  `NouvellesIPtauxSup10Pct` int(11) DEFAULT NULL,
  `deces` int(11) DEFAULT NULL,
  ...
  `sommeTauxIPinf10Pct` int(11) DEFAULT NULL,
  `sommeTauxIP` int(11) DEFAULT NULL,
  `topTMS` varchar(4) DEFAULT NULL,
  `topCancersPros` varchar(4) DEFAULT NULL,
  `topBiologie` varchar(4) DEFAULT NULL,
  KEY `anneeNAF` (`annee`,`NAF`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


--
-- Table structure for table `ameli_t`
--

CREATE TABLE IF NOT EXISTS `ameli_t` (
  `annee` smallint(6) NOT NULL,
  `CTN` varchar(2) NOT NULL,
  `NAF` varchar(5) NOT NULL,
  `NAF2` varchar(2) DEFAULT NULL,
  `NAF38` varchar(2) DEFAULT NULL,
  `codeRisque` varchar(5) NOT NULL,
  `carsatCgss` int(11) NOT NULL,
  `carsatCgss_label` varchar(24) DEFAULT NULL,
  `nbSalariesEnActiviteOuChoPar` int(11) DEFAULT NULL,
  `nbHeuresTravaillees` int(11) DEFAULT NULL,
  `nbSiret` int(11) DEFAULT NULL,
  `AT1erReg` int(11) DEFAULT NULL,
  `AT1erReg4joursArret` int(11) DEFAULT NULL,
  `nouvellesIP` int(11) DEFAULT NULL,
  ...
  `sommeTauxIPinf10Pct` int(11) DEFAULT NULL,
  `sommeTauxIP` int(11) DEFAULT NULL,
  `nombreAccidentTrajetRoutier4joursArret` int(11) DEFAULT NULL,
  PRIMARY KEY (`annee`,`CTN`,`NAF`,`codeRisque`,`carsatCgss`),
  KEY `NAF` (`NAF`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Table structure for table `naf_classes`
--

CREATE TABLE IF NOT EXISTS `naf_classes` (
  `code` varchar(7) NOT NULL,
  `label` varchar(129) DEFAULT NULL,
  PRIMARY KEY (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `naf_classes`
--

INSERT INTO `naf_classes` (`code`, `label`) VALUES
...
--
-- Table structure for table `naf_divisions`
--

CREATE TABLE IF NOT EXISTS `naf_divisions` (
  `code` varchar(2) NOT NULL,
  `label` varchar(138) DEFAULT NULL,
  PRIMARY KEY (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `naf_divisions`
--

INSERT INTO `naf_divisions` (`code`, `label`) VALUES
...
--
-- Table structure for table `naf_groupes`
--

CREATE TABLE IF NOT EXISTS `naf_groupes` (
...
--
-- Dumping data for table `naf_groupes`
--

INSERT INTO `naf_groupes` (`code`, `label`) VALUES
...
--
-- Table structure for table `naf_sections`
--

CREATE TABLE IF NOT EXISTS `naf_sections` (
  `code` varchar(1) NOT NULL,
  `label` varchar(146) DEFAULT NULL,
  PRIMARY KEY (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `naf_sections`
--

INSERT INTO `naf_sections` (`code`, `label`) VALUES
...
--
-- Table structure for table `naf_sousclasses`
--

CREATE TABLE IF NOT EXISTS `naf_sousclasses` (
...
--
-- Dumping data for table `naf_sousclasses`
--

INSERT INTO `naf_sousclasses` (`code`, `label`) VALUES
...
--
-- Table structure for table `naf_tousniveaux`
--

CREATE TABLE IF NOT EXISTS `naf_tousniveaux` (
  `sousclasse` varchar(7) NOT NULL,
  `classe` varchar(7) NOT NULL,
  `groupe` varchar(7) NOT NULL,
  `division` varchar(7) NOT NULL,
  `section` varchar(7) NOT NULL,
  PRIMARY KEY (`sousclasse`),
  KEY `section` (`section`),
...
--
-- Dumping data for table `naf_tousniveaux`
--

INSERT INTO `naf_tousniveaux` (`sousclasse`, `classe`, `groupe`, `division`, `section`) VALUES
